...
export default function Home() {
 ...
 return <div className="page-shell">
  ...
  <header className="site-header"><a className="wordmark" href="/" aria-label="bgvera home"><Scissors size={23}/><span>bgvera</span></a><nav aria-label="Main navigation"><a href="#how-it-works">How it works</a><a href="#questions">Questions</a></nav><span className="header-privacy"><ShieldCheck size={16}/> Made for your privacy</span></header>
  ...
  </main><footer><span>bgvera · A little more room to create.</span><a href="https://huggingface.co/briaai/RMBG-1.4" target="_blank" rel="noreferrer">RMBG-1.4 model & license <ArrowUpRight size={14}/></a></footer>
 </div>
}
